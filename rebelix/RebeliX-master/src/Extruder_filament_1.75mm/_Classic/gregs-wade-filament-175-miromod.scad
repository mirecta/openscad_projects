	...
	mounting_holes=default_mounting_holes)
{
	difference ()
	{
		...
		translate([large_wheel_translation[0]-filament_feed_hole_offset + 13,10,wade_block_depth/2 + filament_feed_hole_position_offset]) rotate([-90,0,0]) 
		  nut_insert_hole();
		translate([large_wheel_translation[0]-filament_feed_hole_offset - 13,8,wade_block_depth/2 + filament_feed_hole_position_offset]) rotate([-90,180,0]) 
		  nut_hole(); 
		...
		translate([large_wheel_translation[0]-filament_feed_hole_offset,
			-base_thickness/2,wade_block_depth/2 + filament_feed_hole_position_offset ])
		rotate([-90,0,0])
		{
...
echo("bhmh", mounting_holes)
	...
	translate(large_wheel_translation)
	{
			...
			// Nabeh pro filament
			translate([-filament_feed_hole_offset,-4,wade_block_depth/2 + filament_feed_hole_position_offset])
			rotate([90,0,0])
			cylinder(r1=filament_feed_hole_d/2+0.5,r2=filament_feed_hole_d/2,h=4,center=true,$fn=18);	
		    
			translate([-filament_feed_hole_offset,20,wade_block_depth/2 + filament_feed_hole_position_offset])
			rotate([90,0,0])
			cylinder(r1=filament_feed_hole_d/2+0.5,r2=filament_feed_hole_d/2,h=4,center=true,$fn=18);
...
bearing_rod_diameter = 5;
	...
	difference(){
	  ...
	  union(){
	    translate([12,15,0]){
          // Hlavni rezy
		  translate([-filament_feed_hole_position_offset,0])difference(){
		  ...
		  translate([-filament_feed_hole_position_offset,0])cube([625_height,24,25], center= true);
		  // Vyrez pro odklopeni
